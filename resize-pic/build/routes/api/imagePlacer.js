...
var fileI = 'plante.jpg';
var path = 'src/public/';
var fileInput = path + fileI;
var fileOutput = path + 'modif_' + fileI;
...
// emit an 'info' event with calculated dimensions
// and finally write image data to writableStream
var myResizer = function (length) { return __awaiter(void 0, void 0, void 0, function () {
    var mypromise;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sharp(fileInput).resize(length).toFile(fileOutput)];
            case 1:
                mypromise = _a.sent();
